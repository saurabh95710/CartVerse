        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="admin/productimages/<?php echo htmlentities($row['productImage1']);?>" alt="<?php echo htmlentities($row['productName']);?>" width="500" height="600"  style="border:solid 1px #000;"/>
...
<img src="admin/productimages/<?php echo htmlentities($row['productImage3']);?>" width="292" style="border:solid 1px #000;">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5">
                            ...
                            <div class="small mb-1"><strong>Shipping/Delivery Chareges:</strong> <?php echo htmlentities($row['shippingCharge']);?></div>
                        </div>
